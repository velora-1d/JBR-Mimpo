            ...
            itemBuilder: (context, index) {
              return GestureDetector(
                ...
                child: Container(
                  ...
                  child: Stack(
                    children: [
                      // Background Aesthetic (Placeholder)
                      Positioned(
                        right: -20,
                        top: -20,
                        child: Opacity(
  ...
  Widget _buildActionButton(String title, IconData icon, Color bg, Color text, {bool isOutlined = false, VoidCallback? onTap}) {
    return Expanded(
      child: Container(
        height: 100,
        decoration: BoxDecoration(
          color: isOutlined ? Theme.of(context).cardColor : bg,
          borderRadius: BorderRadius.circular(AppDimensions.radiusCard),
          border: isOutlined ? Border.all(color: AppColors.primary.withValues(alpha: 0.2), width: 1) : null,
          boxShadow: bg == Colors.white || isOutlined
              ? [BoxShadow(color: Colors.black.withValues(alpha: 0.02), blurRadius: 10, offset: const Offset(0, 4))]
              : [BoxShadow(color: bg.withValues(alpha: 0.2), blurRadius: 10, offset: const Offset(0, 6))],
        ),
        child: Material(
          ...
          child: BackdropFilter(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildNavItem(1, Icons.info_outline_rounded, 'Info'),
                _buildNavItem(2, Icons.local_offer_outlined, 'Promo'),
